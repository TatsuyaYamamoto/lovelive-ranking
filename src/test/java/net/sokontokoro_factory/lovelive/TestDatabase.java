...
public class TestDatabase {
    ...
    private static final String[] BACKUP_TARGET_TABLES = {
            "USER",
            "SCORE",
            "GAME_LOG"
    };
    ...
    public static List<CSVRecord> loadDBUnitCSVFile(String fileName) throws IOException {
        ...
        String filePath = TestDatabase.class.getClassLoader().getResource("dbUnit/" + fileName).getPath();
    ...
    private static Connection getConnection() throws SQLException, ClassNotFoundException {
        Connection connection = DriverManager.getConnection(
                TestDatabase.DATABASE_URL,
                TestDatabase.DATABASE_USER,
                TestDatabase.DATABASE_PASSWORD);
        return connection;
    }
}